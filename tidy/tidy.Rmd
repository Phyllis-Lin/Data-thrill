...
（it is a question about the customer）
...
（it is a question about the hotel）
...
It clearly shows that both of the two hotels have the similar distribution about the interval which represents the day between the original arrival day and the reservation cancelled day. 
