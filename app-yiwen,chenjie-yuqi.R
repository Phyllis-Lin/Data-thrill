...
For customers, we recommend avoiding travel during these three months, and being able to travel off peaks and enjoy better hotel services..",
                                ...
                                fluidRow(
                                  ...
                                  tags$div("According to the plot above, October was the busiest month that even you booking a long time in advanced and you will get a probability to assign different room when you arrive.",
                                           style = "color:black;font-size: 20px;font-weight:normal;"
                                  ),
